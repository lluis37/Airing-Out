    ...
    public static int run(int[][]ship, int[]botCoords, boolean[][]detectionSquare, int k){
        ...
        while (locationOfLeakFound == false) {
                ...
                */
                ...
                detectionSquare = updateDetectionSquare(ship, k, botCoords, detectionSquare);
                ...
                while(detectSensedLeak == true){
                    ...
                    //Find Closest Potential Leak
                    pathToPotentialLeak = findClosestPotentialLeak(ship, detectionSquare, botCoords, previous_places);
        ...
        //DEBUG
        // System.out.printf("Bot 2 Amount of actions is %d\n", amountOfActions);
