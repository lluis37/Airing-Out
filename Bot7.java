...
public class Bot7 {
    ...
    public static double[][] listenForBeep2(int[][] ship, double[][] probabilities, int[][] distanceMatrix, double alpha, int[] leakCoords, int[] leak2Coords, int[] botCoords) {
    ...
    public static int run(int[][] ship, int[] botCoords, int[] leakCoords, int[] leak2Coords, double alpha, ArrayList<Integer> openCells) {
        ...
        while (true) {
            ...
            if (numLeaksFound == 2) {
                ...
                probabilities = listenForBeep2(ship, probabilities, distanceMatrix, alpha, leakCoords, leak2Coords, botCoords);
                numActions++;
            }
